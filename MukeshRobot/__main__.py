...
PM_START_TEXT = """ 
*Hᴇʟʟᴏ {} * [!](https://te.legra.ph/file/4412176d76f2fbdbce02a.jpg)
───────────────────────
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        query.message.edit_text(f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {dispatcher.bot.first_name}*"
            ...
            "\n\n────────────────────"
            f"\n*➻ ᴜᴩᴛɪᴍᴇ »* {uptime}"
            f"\n*➻ ᴜsᴇʀs »* 74{sql.num_users()}"
            f"\n*➻ ᴄʜᴀᴛs »* 88{sql.num_chats()}"
            "\n────────────────────"
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/AlonesHeaven"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="mukesh_support")
                    ]
                ]
            ),
            )  
...
{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://github.com/TeamAloneOp/AloneRobot/fork).
