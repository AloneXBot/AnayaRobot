...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @ALONE_WAS_BOT ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @AlonesHeaven ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="🥀sᴏᴜʀᴄᴇ", url="https://github.com/TeamAloneOp/AloneRobot/fork"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="◁", callback_data="mukesh_back"),
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"https://t.me/AloneXBots"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ 🍹", url="https://github.com/TeamAloneOp/AloneRobot/fork"
                        ),
                    ],
                    [
...
◽️ /staff ɢɪᴠᴇs ᴛʜᴇ ᴄᴏᴍᴘʟᴇᴛᴇ Lɪsᴛ ᴏғ ɢʀᴏᴜᴘ Sᴛᴀғғ!.""",parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="Main_help"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", url=f"https://t.me/AlonesHeaven"
                    ]
                ]
            ),
            )
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/AloneXBots"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", url=f"https://t.me/AlonesHeaven"
                    ]
                ]
            ),
            )  
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/TeamAloneOp/AloneRobot/fork)
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
        InlineKeyboardButton(text="sᴏᴜʀᴄᴇ", url="https://github.com/TeamAloneOp/AloneRobot/fork")
                ],
                 [
        InlineKeyboardButton(text="🏡", callback_data="mukesh_back"),
        InlineKeyboardButton(text="🛡️", callback_data="mukesh_"),
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/AlonesHeaven"
                    ]
                ]
            ),
        )
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://t.me/AloneXMusicBot?startgroup=true"
                            )
                       ]
                ]
                     )
